...
outdir = 'workarea'
saved_signal_hists = f"{outdir}/hists_sigMay2026_ansplitvtx-sel_recoeles.coffea"
...
# Plot settings
plot_dict = {
    'variable': ['reco_N_GED_eles', 'reco_N_Lpt_eles', 'reco_N_photons'], #'reco_N_vtx', 'reco_N_good_vtx'],
    'year': 2024,
    'cut': 'cut8',
}
...
plt.title(rf'Reco N [GED Ele, Lpt Ele, Photons]: $M_1$ = {m1s}, $\Delta$ = {deltas}, c$\tau$ = {ctaus}mm')
plt.legend()
plt.savefig(f"plots/hist_prevtx_reco-n-eles_delta-{utils.stringfy_friendly(deltas[0])}_ctau-{utils.stringfy_friendly(ctaus[0])}_m1-narrow.png")
...
plt.title(rf'Reco N [GED Ele, Lpt Ele, Photons]: $M_1$ = {m1s}, $\Delta$ = {deltas}, c$\tau$ = {ctaus}mm')
plt.legend()
plt.savefig(f"plots/hist_prevtx_reco-n-eles_delta-{utils.stringfy_friendly(deltas[0])}_ctau-{utils.stringfy_friendly(ctaus[0])}_m1-wide.png")
...
plt.title(rf'Reco N [GED Ele, Lpt Ele, Photons]: $M_1$ = {m1s}, $\Delta$ = {deltas}, c$\tau$ = {ctaus}mm')
plt.legend()
plt.savefig(f"plots/hist_prevtx_reco-n-eles_m1-{utils.stringfy_friendly(m1s[0])}_delta-{utils.stringfy_friendly(deltas[0])}.png")
...
plt.title(rf'Reco N [GED Ele, Lpt Ele, Photons]: $M_1$ = {m1s}, $\Delta$ = {deltas}, c$\tau$ = {ctaus}mm')
plt.legend()
plt.savefig(f"plots/hist_prevtx_reco-n-eles_m1-{utils.stringfy_friendly(m1s[0])}_ctau-{utils.stringfy_friendly(ctaus[0])}.png")
