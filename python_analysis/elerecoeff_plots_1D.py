...
proj_configs = [
    {
        ...
        'project': {"samp": sum, "vxy": sum}, 'plottag': 'prevtx_ele-reco_only-pt',  'var': r'$p_T$ [GeV]',
    },
    {
        'variables': ['ele_reco_lpt_pt_lxy', 'ele_reco_ged_pt_lxy', 'ele_reco_none_pt_lxy'],
        'project': {"samp": sum, "pt":  sum}, 'plottag': 'prevtx_ele-reco_only-vxy', 'var': r'$v_{xy}$ [cm]',
    },
    {
        'variables': ['ele_reco_lpt_pt_eta', 'ele_reco_ged_pt_eta', 'ele_reco_none_pt_eta'],
        'project': {"samp": sum, "pt":  sum}, 'plottag': 'prevtx_ele-reco_only-eta', 'var': r'$\eta$',
    },
    {
        'variables': ['ele_reco_lpt_pt_vz', 'ele_reco_ged_pt_vz', 'ele_reco_none_pt_vz'],
        'project': {"samp": sum, "pt":  sum}, 'plottag': 'prevtx_ele-reco_only-vz',  'var': r'$v_z$ [cm]',
    },
]
