...
public:
    ...
    // Cross-Cleaned Low pT electrons (identical to above)
    int nElectronXCLowPt_;
    vector<float> recoXCLowPtElectronPt_;
    vector<float> recoXCLowPtElectronEta_;
    vector<float> recoXCLowPtElectronEtaError_;
    vector<float> recoXCLowPtElectronPhi_;
    vector<float> recoXCLowPtElectronPhiError_;
    vector<float> recoXCLowPtElectronID_;
    vector<float> recoXCLowPtElectronAngularRes_;
    vector<float> recoXCLowPtElectronE_;
    vector<float> recoXCLowPtElectronVxy_;
    vector<float> recoXCLowPtElectronVz_;
    vector<float> recoXCLowPtElectronDxy_;
    vector<float> recoXCLowPtElectronDxyError_;
    vector<float> recoXCLowPtElectronDz_;
    vector<float> recoXCLowPtElectronDzError_;
    vector<float> recoXCLowPtElectronTrkChi2_;
    vector<float> recoXCLowPtElectronTrkIso_;
    vector<float> recoXCLowPtElectronTrkRelIso_;
    vector<float> recoXCLowPtElectronCaloIso_;
    vector<float> recoXCLowPtElectronCaloRelIso_;
    vector<float> recoXCLowPtElectronPFIso_;
    vector<float> recoXCLowPtElectronPFRelIso_;
    vector<float> recoXCLowPtElectronMiniIso_;
    vector<float> recoXCLowPtElectronMiniRelIso_;
    vector<float> recoXCLowPtElectronPFIsoEleCorr_;
    vector<float> recoXCLowPtElectronPFRelIsoEleCorr_;
    vector<float> recoXCLowPtElectronMiniIsoEleCorr_;
    vector<float> recoXCLowPtElectronMiniRelIsoEleCorr_;
    vector<float> recoXCLowPtElectronTrkProb_;
    vector<float> recoXCLowPtElectronChadIso_;
    vector<float> recoXCLowPtElectronNhadIso_;
    vector<float> recoXCLowPtElectronPhoIso_;
    vector<float> recoXCLowPtElectronRhoEA_;
    vector<int> recoXCLowPtElectronTrkNumTrackerHits_;
    vector<int> recoXCLowPtElectronTrkNumPixHits_;
    vector<int> recoXCLowPtElectronTrkNumStripHits_;
    vector<int> recoXCLowPtElectronCharge_;
    vector<float> recoXCLowPtElectronMinDrToReg_;
    vector<bool> recoXCLowPtElectronIsPF_;
    vector<bool> recoXCLowPtElectronGenMatched_;
    vector<int> recoXCLowPtElectronMatchType_;
    vector<vector<float> > recoXCLowPtElectronDrToJets_;
    vector<vector<float> > recoXCLowPtElectronDphiToJets_;
    vector<float> recoXCLowPtElectronFull5x5_sigmaIetaIeta_;
    vector<float> recoXCLowPtElectronAbsdEtaSeed_;
    vector<float> recoXCLowPtElectronAbsdPhiIn_;
    vector<float> recoXCLowPtElectronHoverE_;
    vector<float> recoXCLowPtElectronAbs1overEm1overP_;
