...
void NtupleContainerV2::CreateTreeBranches() {
    ...
    // Cross-cleaned Low pT electrons
    outT->Branch("nXCLptElectron",&nElectronXCLowPt_);
    outT->Branch("XCLptElectron_pt",&recoXCLowPtElectronPt_);
    outT->Branch("XCLptElectron_eta",&recoXCLowPtElectronEta_);
    outT->Branch("XCLptElectron_etaErr",&recoXCLowPtElectronEtaError_);
    outT->Branch("XCLptElectron_phi",&recoXCLowPtElectronPhi_);
    outT->Branch("XCLptElectron_phiErr",&recoXCLowPtElectronPhiError_);
    outT->Branch("XCLptElectron_ID",&recoXCLowPtElectronID_);
    outT->Branch("XCLptElectron_angRes",&recoXCLowPtElectronAngularRes_);
    outT->Branch("XCLptElectron_e",&recoXCLowPtElectronE_);
    outT->Branch("XCLptElectron_vxy",&recoXCLowPtElectronVxy_);
    outT->Branch("XCLptElectron_vz",&recoXCLowPtElectronVz_);
    outT->Branch("XCLptElectron_dxy",&recoXCLowPtElectronDxy_);
    outT->Branch("XCLptElectron_dxyErr",&recoXCLowPtElectronDxyError_);
    outT->Branch("XCLptElectron_dz",&recoXCLowPtElectronDz_);
    outT->Branch("XCLptElectron_dzErr",&recoXCLowPtElectronDzError_);
    outT->Branch("XCLptElectron_trkChi2",&recoXCLowPtElectronTrkChi2_);
    outT->Branch("XCLptElectron_trkIso",&recoXCLowPtElectronTrkIso_);
    outT->Branch("XCLptElectron_trkRelIso",&recoXCLowPtElectronTrkRelIso_);
    outT->Branch("XCLptElectron_calIso",&recoXCLowPtElectronCaloIso_);
    outT->Branch("XCLptElectron_calRelIso",&recoXCLowPtElectronCaloRelIso_);
    outT->Branch("XCLptElectron_PFIso",&recoXCLowPtElectronPFIso_);
    outT->Branch("XCLptElectron_PFRelIso",&recoXCLowPtElectronPFRelIso_);
    outT->Branch("XCLptElectron_miniIso",&recoXCLowPtElectronMiniIso_);
    outT->Branch("XCLptElectron_miniRelIso",&recoXCLowPtElectronMiniRelIso_);
    outT->Branch("XCLptElectron_PFIsoEleCorr",&recoXCLowPtElectronPFIsoEleCorr_);
    outT->Branch("XCLptElectron_PFRelIsoEleCorr",&recoXCLowPtElectronPFRelIsoEleCorr_);
    outT->Branch("XCLptElectron_miniIsoEleCorr",&recoXCLowPtElectronMiniIsoEleCorr_);
    outT->Branch("XCLptElectron_miniRelIsoEleCorr",&recoXCLowPtElectronMiniRelIsoEleCorr_);
    outT->Branch("XCLptElectron_chadIso",&recoXCLowPtElectronChadIso_);
    outT->Branch("XCLptElectron_nhadIso",&recoXCLowPtElectronNhadIso_);
    outT->Branch("XCLptElectron_phoIso",&recoXCLowPtElectronPhoIso_);
    outT->Branch("XCLptElectron_rhoEA",&recoXCLowPtElectronRhoEA_);
    outT->Branch("XCLptElectron_trkProb",&recoXCLowPtElectronTrkProb_);
    outT->Branch("XCLptElectron_numTrackerHits",&recoXCLowPtElectronTrkNumTrackerHits_);
    outT->Branch("XCLptElectron_numPixHits",&recoXCLowPtElectronTrkNumPixHits_);
    outT->Branch("XCLptElectron_numStripHits",&recoXCLowPtElectronTrkNumStripHits_);
    outT->Branch("XCLptElectron_charge",&recoXCLowPtElectronCharge_);
    outT->Branch("XCLptElectron_minDRtoReg",&recoXCLowPtElectronMinDrToReg_);
    outT->Branch("XCLptElectron_isPF",&recoXCLowPtElectronIsPF_);
    outT->Branch("XCLptElectron_genMatched",&recoXCLowPtElectronGenMatched_);
    outT->Branch("XCLptElectron_matchType",&recoXCLowPtElectronMatchType_);
    outT->Branch("XCLptElectron_dRJets",&recoXCLowPtElectronDrToJets_);
    outT->Branch("XCLptElectron_dPhiJets",&recoXCLowPtElectronDphiToJets_);
    outT->Branch("XCLptElectron_full55sigmaIetaIeta",&recoXCLowPtElectronFull5x5_sigmaIetaIeta_);
    outT->Branch("XCLptElectron_absdEtaSeed",&recoXCLowPtElectronAbsdEtaSeed_);
    outT->Branch("XCLptElectron_absdPhiIn",&recoXCLowPtElectronAbsdPhiIn_);
    outT->Branch("XCLptElectron_HoverE",&recoXCLowPtElectronHoverE_);
    outT->Branch("XCLptElectron_abs1overEm1overP",&recoXCLowPtElectronAbs1overEm1overP_);
...
void NtupleContainerV2::ClearTreeBranches() {
    ...
    // Low pT electrons
    nElectronXCLowPt_ = 0;
    recoXCLowPtElectronPt_.clear();
    recoXCLowPtElectronEta_.clear();
    recoXCLowPtElectronEtaError_.clear();
    recoXCLowPtElectronPhi_.clear();
    recoXCLowPtElectronPhiError_.clear();
    recoXCLowPtElectronID_.clear();
    recoXCLowPtElectronAngularRes_.clear();
    recoXCLowPtElectronE_.clear();
    recoXCLowPtElectronVxy_.clear();
    recoXCLowPtElectronVz_.clear();
    recoXCLowPtElectronDxy_.clear();
    recoXCLowPtElectronDxyError_.clear();
    recoXCLowPtElectronDz_.clear();
    recoXCLowPtElectronDzError_.clear();
    recoXCLowPtElectronTrkChi2_.clear();
    recoXCLowPtElectronTrkIso_.clear();
    recoXCLowPtElectronTrkRelIso_.clear();
    recoXCLowPtElectronCaloIso_.clear();
    recoXCLowPtElectronCaloRelIso_.clear();
    recoXCLowPtElectronPFIso_.clear();
    recoXCLowPtElectronPFRelIso_.clear();
    recoXCLowPtElectronMiniIso_.clear();
    recoXCLowPtElectronMiniRelIso_.clear();
    recoXCLowPtElectronPFIsoEleCorr_.clear();
    recoXCLowPtElectronPFRelIsoEleCorr_.clear();
    recoXCLowPtElectronMiniIsoEleCorr_.clear();
    recoXCLowPtElectronMiniRelIsoEleCorr_.clear();
    recoXCLowPtElectronChadIso_.clear();
    recoXCLowPtElectronNhadIso_.clear();
    recoXCLowPtElectronPhoIso_.clear();
    recoXCLowPtElectronRhoEA_.clear();
    recoXCLowPtElectronTrkProb_.clear();
    recoXCLowPtElectronTrkNumTrackerHits_.clear();
    recoXCLowPtElectronTrkNumPixHits_.clear();
    recoXCLowPtElectronTrkNumStripHits_.clear();
    recoXCLowPtElectronCharge_.clear();
    recoXCLowPtElectronMinDrToReg_.clear();
    recoXCLowPtElectronIsPF_.clear();
    recoXCLowPtElectronGenMatched_.clear();
    recoXCLowPtElectronMatchType_.clear();
    recoXCLowPtElectronDrToJets_.clear();
    recoXCLowPtElectronDphiToJets_.clear();
    recoXCLowPtElectronFull5x5_sigmaIetaIeta_.clear();
    recoXCLowPtElectronAbsdEtaSeed_.clear();
    recoXCLowPtElectronAbsdPhiIn_.clear();
    recoXCLowPtElectronHoverE_.clear();
    recoXCLowPtElectronAbs1overEm1overP_.clear();
    recoXCLowPtElectronExpMissingInnerHits_.clear();
    recoXCLowPtElectronConversionVeto_.clear();
    recoXCLowPtElectronIsEE_.clear();
